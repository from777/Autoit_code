...
Func _Start_plink2($_plink_loc, $_plinkserver, $_plink_user = "", $_plink_Password = "", $_plink_Conection_Type = "Telnet", $_plink_Port = "23", $ssh_key = "")
	...
	If $Protocol = " -ssh " Then ;ssh
		$_plinkhandle = Run(@ComSpec & " /c" & $_plink_loc & $Protocol & "-P " & $_plink_Port & " " & $_plinkserver & $LogonData, "", @SW_HIDE, $STDIN_CHILD + $STDOUT_CHILD)
	Else; not ssh
...
$_plinkhandle = Run(@comspec & " /c" & $_plink_loc & " -ssh " & $_plinkserver,"",@SW_MAXIMIZE,7)
return $_plinkhandle
endFunc
; ===============================================================================================================================
